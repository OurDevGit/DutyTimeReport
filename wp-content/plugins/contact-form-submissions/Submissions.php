...
class WPCF7Submissions
{
    ...
    public function post_type()
    {
        ...
        $labels = array(
            ...
            'singular_name'       => __('Duty Time', 'contact-form-submissions'),
            'menu_name'           => __('Duty Time', 'contact-form-submissions'),
            'all_items'           => __('Duty Time', 'contact-form-submissions'),
            'view_item'           => __('Duty Time', 'contact-form-submissions'),
            'edit_item'           => __('Duty Time', 'contact-form-submissions'),
        ...
        $args = array(
            'label'               => __('Duty Time', 'contact-form-submissions'),
